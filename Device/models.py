...
class bms_area_master(models.Model):
    tower1_id=models.ManyToManyField(bms_building_master,related_name='tower')
    floor_id=models.ManyToManyField(bms_floor_master,related_name='floor1')
...
class bms_sub_area_master(models.Model):
    # tower2_id=models.ManyToManyField(bms_building_master,related_name='tower2')
    # floor1_id=models.ManyToManyField(bms_floor_master,related_name='floor2')
    area1_id=models.ManyToManyField(bms_area_master,related_name='area')
