...
class Bms_sub_area_master_Serializer(serializers.ModelSerializer):
    tower2_id=Bms_Bulding_master_Serializer(many=True,read_only=True)
    floor1_id=Bms_floor_master_Serializer(many=True,read_only=True)
    class Meta:
